...
from flask import Flask, session, flash, render_template, Response, request, redirect, send_file, url_for, jsonify
...
allowed_extensions = ['avi', 'mp4', 'webm']
...
def detect():
    ...
    if file.filename == '':
        ...
        subprocess.call(["python", "detect.py", os.path.join(app.config['UPLOAD_FOLDER'], filename)], shell=True)
